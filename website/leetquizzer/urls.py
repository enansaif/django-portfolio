...
urlpatterns = [
    ...
    path('by_topic/', views.TopicMenu.as_view(), name='topic_menu'),
    path('by_difficulty/', views.DifficultyMenu.as_view(), name='difficulty_menu'),
    ...
    path('<int:problem_id>/problem/', views.ProblemMenu.as_view(), name='problem_menu'),
]